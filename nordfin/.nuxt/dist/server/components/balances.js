...
module.exports = __webpack_require__.p + "img/sollogo.1d961c8.webp";
...
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Balances_vue_vue_type_style_index_0_id_dbc17f82_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(71);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Balances_vue_vue_type_style_index_0_id_dbc17f82_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Balances_vue_vue_type_style_index_0_id_dbc17f82_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0__);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Balances_vue_vue_type_style_index_0_id_dbc17f82_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0__) if(["default"].indexOf(__WEBPACK_IMPORT_KEY__) < 0) (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Balances_vue_vue_type_style_index_0_id_dbc17f82_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
...
// Module
___CSS_LOADER_EXPORT___.push([module.i, ".balances__header[data-v-dbc17f82]{text-transform:uppercase;font-size:calc(clamp(350px, 100vw, 3840px)/var(--ideal-viewport-width)*15);margin-bottom:calc(clamp(350px, 100vw, 3840px)/var(--ideal-viewport-width)*15)}@media only screen and (max-width:414px){.balances__header[data-v-dbc17f82]{font-size:calc(clamp(350px, 100vw, 3840px)/var(--ideal-viewport-width)*60)}}.balances__header span[data-v-dbc17f82]{display:inline-block;text-align:center;padding:calc(clamp(350px, 100vw, 3840px)/var(--ideal-viewport-width)*16);position:relative;margin-right:calc(clamp(350px, 100vw, 3840px)/var(--ideal-viewport-width)*16);cursor:pointer;font-weight:600}@media only screen and (max-width:414px){.balances__header span[data-v-dbc17f82]{display:block;text-align:left;padding:calc(clamp(350px, 100vw, 3840px)/var(--ideal-viewport-width)*40) calc(clamp(350px, 100vw, 3840px)/var(--ideal-viewport-width)*16);margin-bottom:calc(clamp(350px, 100vw, 3840px)/var(--ideal-viewport-width)*30)}}.balances__header span[data-v-dbc17f82]:before{content:\"\";left:0;bottom:0;position:absolute;background:transparent;border-radius:3rem;height:calc(clamp(350px, 100vw, 3840px)/var(--ideal-viewport-width)*4);width:100%}.balances__header span.current[data-v-dbc17f82]{color:#00b4c9}.balances__header span.current[data-v-dbc17f82]:before{background:#00b4c9}.balances__toparea--btnsarea[data-v-dbc17f82]{display:flex;text-transform:uppercase;font-size:calc(clamp(350px, 100vw, 3840px)/var(--ideal-viewport-width)*12);justify-content:space-between;align-items:center;padding-left:calc(clamp(350px, 100vw, 3840px)/var(--ideal-viewport-width)*140)}.balances__toparea--btnsarea span[data-v-dbc17f82]{border:.5px solid hsla(0,0%,100%,.6);padding:calc(clamp(350px, 100vw, 3840px)/var(--ideal-viewport-width)*14);border-radius:.6rem;display:inline-block;margin-left:calc(clamp(350px, 100vw, 3840px)/var(--ideal-viewport-width)*15);cursor:pointer}.balances__toparea--btnsarea span.completeverification[data-v-dbc17f82]{background:rgba(0,180,201,.6);border:.5px solid rgba(0,180,201,.6)}@media only screen and (max-width:414px){.balances__toparea--btnsarea span[data-v-dbc17f82]{margin-bottom:calc(clamp(350px, 100vw, 3840px)/var(--ideal-viewport-width)*57);padding:calc(clamp(350px, 100vw, 3840px)/var(--ideal-viewport-width)*30)}}@media only screen and (max-width:414px){.balances__toparea--btnsarea[data-v-dbc17f82]{font-size:calc(clamp(350px, 100vw, 3840px)/var(--ideal-viewport-width)*57);flex-direction:column;align-items:flex-start}}.balances__toparea--svgs[data-v-dbc17f82]{font-size:calc(clamp(350px, 100vw, 3840px)/var(--ideal-viewport-width)*18);margin-top:calc(clamp(350px, 100vw, 3840px)/var(--ideal-viewport-width)*35)}@media only screen and (max-width:414px){.balances__toparea--svgs[data-v-dbc17f82]{font-size:calc(clamp(350px, 100vw, 3840px)/var(--ideal-viewport-width)*70)}}.balances__toparea--labels[data-v-dbc17f82]{font-size:calc(clamp(350px, 100vw, 3840px)/var(--ideal-viewport-width)*12);margin-top:calc(clamp(350px, 100vw, 3840px)/var(--ideal-viewport-width)*20);color:hsla(0,0%,100%,.5);display:flex;align-items:center;padding-bottom:calc(clamp(350px, 100vw, 3840px)/var(--ideal-viewport-width)*12)}@media only screen and (max-width:414px){.balances__toparea--labels[data-v-dbc17f82]{display:none}}.balances__toparea--labels span[data-v-dbc17f82]{display:inline-block;width:calc(clamp(350px, 100vw, 3840px)/var(--ideal-viewport-width)*200)}.balances__toparea--labels span[data-v-dbc17f82]:first-child{width:calc(clamp(350px, 100vw, 3840px)/var(--ideal-viewport-width)*400)}.balances__balance[data-v-dbc17f82]{display:flex;align-items:center;font-size:calc(clamp(350px, 100vw, 3840px)/var(--ideal-viewport-width)*12);font-weight:300;padding:calc(clamp(350px, 100vw, 3840px)/var(--ideal-viewport-width)*5) 0;border-top:1px solid hsla(0,0%,100%,.2)}@media only screen and (max-width:414px){.balances__balance[data-v-dbc17f82]{font-size:calc(clamp(350px, 100vw, 3840px)/var(--ideal-viewport-width)*60);padding:calc(clamp(350px, 100vw, 3840px)/var(--ideal-viewport-width)*40) calc(clamp(350px, 100vw, 3840px)/var(--ideal-viewport-width)*20);flex-direction:column;align-items:flex-start}}.balances__balance--label[data-v-dbc17f82]{width:calc(clamp(350px, 100vw, 3840px)/var(--ideal-viewport-width)*400);display:flex;align-items:center}@media only screen and (max-width:414px){.balances__balance--label[data-v-dbc17f82]{width:100%;margin-bottom:calc(clamp(350px, 100vw, 3840px)/var(--ideal-viewport-width)*30)}}.balances__balance--logo[data-v-dbc17f82]{height:calc(clamp(350px, 100vw, 3840px)/var(--ideal-viewport-width)*20);width:calc(clamp(350px, 100vw, 3840px)/var(--ideal-viewport-width)*20);border-radius:100%;overflow:hidden;margin-right:calc(clamp(350px, 100vw, 3840px)/var(--ideal-viewport-width)*10)}@media only screen and (max-width:414px){.balances__balance--logo[data-v-dbc17f82]{height:calc(clamp(350px, 100vw, 3840px)/var(--ideal-viewport-width)*100);width:calc(clamp(350px, 100vw, 3840px)/var(--ideal-viewport-width)*100);margin-right:calc(clamp(350px, 100vw, 3840px)/var(--ideal-viewport-width)*30)}}.balances__balance--logo img[data-v-dbc17f82]{-o-object-fit:cover;object-fit:cover;height:100%;width:100%}.balances__balance--area[data-v-dbc17f82]{width:calc(clamp(350px, 100vw, 3840px)/var(--ideal-viewport-width)*200)}@media only screen and (max-width:414px){.balances__balance--area[data-v-dbc17f82]{width:100%;padding:calc(clamp(350px, 100vw, 3840px)/var(--ideal-viewport-width)*20)}}.balances__balance--area span.mobilelabel[data-v-dbc17f82]{display:none}@media only screen and (max-width:414px){.balances__balance--area span.mobilelabel[data-v-dbc17f82]{display:inline-block;margin-right:calc(clamp(350px, 100vw, 3840px)/var(--ideal-viewport-width)*20);color:green}}.balances__balance button.verification[data-v-dbc17f82]{background:#1c2230;padding:calc(clamp(350px, 100vw, 3840px)/var(--ideal-viewport-width)*10) calc(clamp(350px, 100vw, 3840px)/var(--ideal-viewport-width)*15);border-radius:.6rem;font-size:calc(clamp(350px, 100vw, 3840px)/var(--ideal-viewport-width)*12)}@media only screen and (max-width:414px){.balances__balance button.verification[data-v-dbc17f82]{font-size:calc(clamp(350px, 100vw, 3840px)/var(--ideal-viewport-width)*50);padding:calc(clamp(350px, 100vw, 3840px)/var(--ideal-viewport-width)*18) 0;text-align:left;margin-top:calc(clamp(350px, 100vw, 3840px)/var(--ideal-viewport-width)*50);background:transparent;color:rgba(0,180,201,.6);line-height:calc(clamp(350px, 100vw, 3840px)/var(--ideal-viewport-width)*70)}}", ""]);
// Exports
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./components/Balances.vue?vue&type=template&id=dbc17f82&scoped=true&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"balances"},[_vm._ssrNode("<section class=\"balances__header\" data-v-dbc17f82><span"+(_vm._ssrClass(null,{
          current: _vm.view === 'balances'
      }))+" data-v-dbc17f82>balances</span> <span"+(_vm._ssrClass(null,{
          current: _vm.view === 'deposits'
      }))+" data-v-dbc17f82>deposits</span> <span"+(_vm._ssrClass(null,{
          current: _vm.view === 'withdrawals'
      }))+" data-v-dbc17f82>withdrawals</span> <span"+(_vm._ssrClass(null,{
          current: _vm.view === 'fills'
      }))+" data-v-dbc17f82>fills</span> <span"+(_vm._ssrClass(null,{
          current: _vm.view === 'conversions'
      }))+" data-v-dbc17f82>conversions</span> <span"+(_vm._ssrClass(null,{
          current: _vm.view === 'collateral explainer'
      }))+" data-v-dbc17f82>collateral explainer</span></section> "+((_vm.view === 'balances')?("<section class=\"balances__toparea\" data-v-dbc17f82><div class=\"balances__toparea--btnsarea\" data-v-dbc17f82><div class=\"balances__toparea--btnsarealeft\" data-v-dbc17f82><span data-v-dbc17f82>all balances</span> <span data-v-dbc17f82>crypto</span> <span data-v-dbc17f82>fiat</span></div> <div class=\"balances__toparea--btnsarearight\" data-v-dbc17f82><span class=\"completeverification\" data-v-dbc17f82>complete id verification to deposit by card</span></div></div> <div class=\"balances__toparea--svgs\" data-v-dbc17f82><div class=\"balances__toparea--svgsleft\" data-v-dbc17f82><p data-v-dbc17f82>Balances</p></div> <div class=\"balances__toparea--svgsright\" data-v-dbc17f82><span data-v-dbc17f82></span></div></div> <div class=\"balances__toparea--labels\" data-v-dbc17f82><span data-v-dbc17f82>Coin</span> <span data-v-dbc17f82>Balance</span> <span data-v-dbc17f82>Available Balance</span> <span data-v-dbc17f82>USD Value</span></div></section>"):"<!---->")+" "+((_vm.view === 'balances')?("<section class=\"balances__row\" data-v-dbc17f82><div class=\"balances__balance\" data-v-dbc17f82><div class=\"balances__balance--label\" data-v-dbc17f82><figure class=\"balances__balance--logo\" data-v-dbc17f82><img src=\"data:image/png;base64,\" data-v-dbc17f82></figure> <span data-v-dbc17f82>USD (USD)</span></div> <span class=\"balances__balance--area\" data-v-dbc17f82><span class=\"mobilelabel\" data-v-dbc17f82>Balance</span>0.00</span> <span class=\"balances__balance--area\" data-v-dbc17f82><span class=\"mobilelabel\" data-v-dbc17f82>Available Balance</span>0.00</span> <span class=\"balances__balance--area\" data-v-dbc17f82><span class=\"mobilelabel\" data-v-dbc17f82>USD Value</span>US$0.00</span> <button class=\"verification\" data-v-dbc17f82>COMPLETE IDENTITY VERIFICATION TO DEPOSIT/WITHDRAW</button></div> <div class=\"balances__balance\" data-v-dbc17f82><div class=\"balances__balance--label\" data-v-dbc17f82><figure class=\"balances__balance--logo\" data-v-dbc17f82><img src=\"data:image/png;base64,\" data-v-dbc17f82></figure> <span data-v-dbc17f82>USD Tether (USDT)</span></div> <span class=\"balances__balance--area\" data-v-dbc17f82><span class=\"mobilelabel\" data-v-dbc17f82>Balance</span>0.00</span> <span class=\"balances__balance--area\" data-v-dbc17f82><span class=\"mobilelabel\" data-v-dbc17f82>Available Balance</span>0.00</span> <span class=\"balances__balance--area\" data-v-dbc17f82><span class=\"mobilelabel\" data-v-dbc17f82>USD Value</span>US$0.00</span> <button class=\"verification\" data-v-dbc17f82>COMPLETE IDENTITY VERIFICATION TO DEPOSIT/WITHDRAW</button></div> <div class=\"balances__balance\" data-v-dbc17f82><div class=\"balances__balance--label\" data-v-dbc17f82><figure class=\"balances__balance--logo\" data-v-dbc17f82><img src=\"data:image/png;base64,\" data-v-dbc17f82></figure> <span data-v-dbc17f82>Bitcoin (BTC)</span></div> <span class=\"balances__balance--area\" data-v-dbc17f82><span class=\"mobilelabel\" data-v-dbc17f82>Balance</span>0.00</span> <span class=\"balances__balance--area\" data-v-dbc17f82><span class=\"mobilelabel\" data-v-dbc17f82>Available Balance</span>0.00</span> <span class=\"balances__balance--area\" data-v-dbc17f82><span class=\"mobilelabel\" data-v-dbc17f82>USD Value</span>US$0.00</span> <button class=\"verification\" data-v-dbc17f82>COMPLETE IDENTITY VERIFICATION TO DEPOSIT/WITHDRAW</button></div> <div class=\"balances__balance\" data-v-dbc17f82><div class=\"balances__balance--label\" data-v-dbc17f82><figure class=\"balances__balance--logo\" data-v-dbc17f82><img src=\"data:image/png;base64,\" data-v-dbc17f82></figure> <span data-v-dbc17f82>Ethereum (ETH)</span></div> <span class=\"balances__balance--area\" data-v-dbc17f82><span class=\"mobilelabel\" data-v-dbc17f82>Balance</span>0.00</span> <span class=\"balances__balance--area\" data-v-dbc17f82><span class=\"mobilelabel\" data-v-dbc17f82>Available Balance</span>0.00</span> <span class=\"balances__balance--area\" data-v-dbc17f82><span class=\"mobilelabel\" data-v-dbc17f82>USD Value</span>US$0.00</span> <button class=\"verification\" data-v-dbc17f82>COMPLETE IDENTITY VERIFICATION TO DEPOSIT/WITHDRAW</button></div> <div class=\"balances__balance\" data-v-dbc17f82><div class=\"balances__balance--label\" data-v-dbc17f82><figure class=\"balances__balance--logo\" data-v-dbc17f82><img src=\"data:image/png;base64,\" data-v-dbc17f82></figure> <span data-v-dbc17f82>Litecoin (LTC)</span></div> <span class=\"balances__balance--area\" data-v-dbc17f82><span class=\"mobilelabel\" data-v-dbc17f82>Balance</span>0.00</span> <span class=\"balances__balance--area\" data-v-dbc17f82><span class=\"mobilelabel\" data-v-dbc17f82>Available Balance</span>0.00</span> <span class=\"balances__balance--area\" data-v-dbc17f82><span class=\"mobilelabel\" data-v-dbc17f82>USD Value</span>US$0.00</span> <button class=\"verification\" data-v-dbc17f82>COMPLETE IDENTITY VERIFICATION TO DEPOSIT/WITHDRAW</button></div> <div class=\"balances__balance\" data-v-dbc17f82><div class=\"balances__balance--label\" data-v-dbc17f82><figure class=\"balances__balance--logo\" data-v-dbc17f82><img"+(_vm._ssrAttr("src",__webpack_require__(101)))+" data-v-dbc17f82></figure> <span data-v-dbc17f82>Solana (SOL)</span></div> <span class=\"balances__balance--area\" data-v-dbc17f82><span class=\"mobilelabel\" data-v-dbc17f82>Balance</span>0.00</span> <span class=\"balances__balance--area\" data-v-dbc17f82><span class=\"mobilelabel\" data-v-dbc17f82>Available Balance</span>0.00</span> <span class=\"balances__balance--area\" data-v-dbc17f82><span class=\"mobilelabel\" data-v-dbc17f82>USD Value</span>US$0.00</span> <button class=\"verification\" data-v-dbc17f82>COMPLETE IDENTITY VERIFICATION TO DEPOSIT/WITHDRAW</button></div> <div class=\"balances__balance\" data-v-dbc17f82><div class=\"balances__balance--label\" data-v-dbc17f82><figure class=\"balances__balance--logo\" data-v-dbc17f82><img src=\"data:image/png;base64,\" data-v-dbc17f82></figure> <span data-v-dbc17f82>HUSD (HUSD)</span></div> <span class=\"balances__balance--area\" data-v-dbc17f82><span class=\"mobilelabel\" data-v-dbc17f82>Balance</span>0.00</span> <span class=\"balances__balance--area\" data-v-dbc17f82><span class=\"mobilelabel\" data-v-dbc17f82>Available Balance</span>0.00</span> <span class=\"balances__balance--area\" data-v-dbc17f82><span class=\"mobilelabel\" data-v-dbc17f82>USD Value</span>US$0.00</span> <button class=\"verification\" data-v-dbc17f82>COMPLETE IDENTITY VERIFICATION TO DEPOSIT/WITHDRAW</button></div> <div class=\"balances__balance\" data-v-dbc17f82><div class=\"balances__balance--label\" data-v-dbc17f82><figure class=\"balances__balance--logo\" data-v-dbc17f82><img src=\"data:image/png;base64,\" data-v-dbc17f82></figure> <span data-v-dbc17f82>Euro (EUR)</span></div> <span class=\"balances__balance--area\" data-v-dbc17f82><span class=\"mobilelabel\" data-v-dbc17f82>Balance</span>0.00</span> <span class=\"balances__balance--area\" data-v-dbc17f82><span class=\"mobilelabel\" data-v-dbc17f82>Available Balance</span>0.00</span> <span class=\"balances__balance--area\" data-v-dbc17f82><span class=\"mobilelabel\" data-v-dbc17f82>USD Value</span>US$0.00</span> <button class=\"verification\" data-v-dbc17f82>COMPLETE IDENTITY VERIFICATION TO DEPOSIT/WITHDRAW</button></div></section>"):"<!---->")+" "),_vm._ssrNode("<section class=\"balances__records\" data-v-dbc17f82>","</section>",[(_vm.view === 'deposits')?_c('Record',{attrs:{"labels":['time', 'coin', 'amount', 'status', 'additional info'],"records":[],"header":'Deposits',"btnlabel":'Make a deposit'}}):_vm._e(),_vm._ssrNode(" "),(_vm.view === 'withdrawals')?_c('Record',{attrs:{"labels":['time', 'coin', 'amount', 'destination', 'status'],"records":[],"header":'Withdrawals',"btnlabel":'Make a withdrawal'}}):_vm._e(),_vm._ssrNode(" "),(_vm.view === 'fills')?_c('Record',{attrs:{"labels":['time', 'market', 'side', 'order type', 'size', 'price', 'total', 'fee', 'TWAP'],"records":[],"header":'Fills'}}):_vm._e(),_vm._ssrNode(" "),(_vm.view === 'conversions')?_c('Record',{attrs:{"labels":['time', 'from', 'to', 'size', 'fee', 'price', 'proceeds', 'status'],"records":[],"header":'Conversions'}}):_vm._e(),_vm._ssrNode(" "),(_vm.view === 'collateral explainer')?_vm._ssrNode("<section data-v-dbc17f82>","</section>",[(_vm.view === 'collateral explainer')?_c('Record',{attrs:{"labels":['coin', 'total balance', 'balance available as collateral', 'approximate fair', 'collateral weight'],"records":[],"header":'Collateral contribution of positive balances'}}):_vm._e(),_vm._ssrNode(" "),(_vm.view === 'collateral explainer')?_c('Record',{attrs:{"labels":['coin', 'amount'],"records":[],"header":'Staked balances'}}):_vm._e(),_vm._ssrNode(" "),(_vm.view === 'collateral explainer')?_c('Record',{attrs:{"labels":['coin', 'amount'],"records":[],"header":'Lent balances'}}):_vm._e(),_vm._ssrNode(" "),(_vm.view === 'collateral explainer')?_c('Record',{attrs:{"labels":['coin', 'amount'],"records":[],"header":'Balances locked in open orders'}}):_vm._e(),_vm._ssrNode(" "),(_vm.view === 'collateral explainer')?_c('Record',{attrs:{"labels":['coin', 'balance', 'size from open orders', 'position', 'mark price', 'position value', 'additional collateral used'],"records":[],"header":'Negative balances (including open orders)'}}):_vm._e(),_vm._ssrNode(" "),(_vm.view === 'collateral explainer')?_c('Record',{attrs:{"labels":['ticker', 'quantity', 'size from open orders', 'position', 'mark price', 'margin fraction required'],"records":[],"header":'Positions (including open orders)'}}):_vm._e()],2):_vm._e()],2)],2)}
var staticRenderFns = []


// CONCATENATED MODULE: ./components/Balances.vue?vue&type=template&id=dbc17f82&scoped=true&

// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./components/Balances.vue?vue&type=script&lang=js&
//
//
//
//
...
//
//
/* harmony default export */ var Balancesvue_type_script_lang_js_ = ({
  data() {
    return {
      view: 'balances'
    };
...
// CONCATENATED MODULE: ./components/Balances.vue?vue&type=script&lang=js&
 /* harmony default export */ var components_Balancesvue_type_script_lang_js_ = (Balancesvue_type_script_lang_js_); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(2);

// CONCATENATED MODULE: ./components/Balances.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  components_Balancesvue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  injectStyles,
...
/* harmony default export */ var Balances = __webpack_exports__["default"] = (component.exports);

/* nuxt-component-imports */
installComponents(component, {Record: __webpack_require__(45).default})
...
var add = __webpack_require__(6).default
module.exports.__inject__ = function (context) {
  add("9142d80e", content, true, context)
};
