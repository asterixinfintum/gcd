<template>
  <div class="dashboard">
    ...
    <div class="dashboard__topbtns">
      <NuxtLink class="createasset" to="/admin/createasset">Create Asset</Nuxtlink>
      <NuxtLink class="createasset" to="/admin/viewassets">View Assets</Nuxtlink>
    </div>
    <div class="dashboard__list" v-if="users">
      <h2 class="dashboard__h2">Grant Cred Users</h2>
